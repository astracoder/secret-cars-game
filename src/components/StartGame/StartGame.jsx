const StartGame = ({ startGame }) => {
    return (
        <main className="bg-start-game bg-cover bg-center">
            <section className="backdrop-blur-sm bg-black/80 w-screen h-screen flex justify-center justify-items-center items-center flex-col">
