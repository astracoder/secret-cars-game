...
const StartGame = ({ 
    ...
    return (
        <main className="w-screen h-screen flex justify-center items-center flex-col backdrop-blur-sm bg-black/60 game">
            <p className="text-white text-center text-2xl mb-10">Pontuação: <span className="text-xl bg-purple-500 p-2 pt-1 pb-1 rounded-md points">{score}</span></p>
