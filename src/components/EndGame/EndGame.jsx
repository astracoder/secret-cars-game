    ...
    return (
        ...
        ">
            ...
            <div className="flex justify-center">
                <p className="text-white font-bold text-3xl bg-purple-500 p-2 pt-1 pb-1 rounded-full w-20 h-20 flex justify-center items-center">{score}</p>
            </div>
            <div className="flex justify-center">
                <button onClick={retryStage} className="p-3 mt-10 text-2xl text-white rounded-md bg-purple-500 hover:bg-purple-600 transition ease-in-out">Jogar novamente!</button>
            </div>
        </main>
    )
}
